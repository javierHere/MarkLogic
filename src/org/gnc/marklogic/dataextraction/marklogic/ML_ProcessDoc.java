 ...
 */
public class ML_ProcessDoc implements Runnable {
    ...
    public ML_ProcessDoc(DocumentRecord document, ArrayList<String> elements, PrintStream out, String DELIMITER, XMLDocumentManager docMgr, String ROOT_NODE, String CUSTOM_TRANSFORM) {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(ML_ProcessDoc.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
