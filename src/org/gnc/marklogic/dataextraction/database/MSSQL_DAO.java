 ...
 */
public class MSSQL_DAO extends DAO {
    ...
    public void closeConnection() {
        if (conn != null) {
            try {
                ...
                Logger.getLogger(MSSQL_DAO.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    public void openConnection(String url, String username, String password) {
        // username and password are not used as we are just using integrated security for now
        try {
            if (conn == null) {
