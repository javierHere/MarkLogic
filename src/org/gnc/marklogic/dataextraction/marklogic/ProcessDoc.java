...
public class ProcessDoc implements Runnable {
    ...
    public ProcessDoc(DocumentRecord document, ArrayList<String> elements, PrintStream out, String DELIMITER, XMLDocumentManager docMgr, String ROOT_NODE, String CUSTOM_TRANSFORM) {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(ProcessDoc.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    // this method has been built to work for steritech and needs further fine tuning to be fully generic
