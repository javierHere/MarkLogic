 ...
 */
public class ML_ProcessPage implements Runnable {
    ...
    private void processPage() {
        ...
        for (DocumentRecord document : documents) {
            ...
            processDoc = new ML_ProcessDoc(document, elements, out, DELIMITER, docMgr, ROOT_NODE, CUSTOM_TRANSFORM);
