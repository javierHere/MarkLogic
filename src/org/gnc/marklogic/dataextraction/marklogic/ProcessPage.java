...
public class ProcessPage implements Runnable {
    ...
    public ProcessPage(DocumentPage documents, ArrayList<String> elements, PrintStream out, String DELIMITER, XMLDocumentManager docMgr, String ROOT_NODE, String CUSTOM_TRANSFORM) {
    ...
    private void processPage() {
        ...
        for (DocumentRecord document : documents) {
            ...
            processDoc = new ProcessDoc(document, elements, out, DELIMITER, docMgr, ROOT_NODE, CUSTOM_TRANSFORM);
