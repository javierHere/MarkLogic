...
public class Marklogic_ProcessPage implements Runnable {
    ...
    public Marklogic_ProcessPage(DocumentPage documents, ArrayList<String> elements, PrintStream out, String DELIMITER, XMLDocumentManager docMgr, String ROOT_NODE, String CUSTOM_TRANSFORM) {
    ...
    private void processPage() {
        ...
        for (DocumentRecord document : documents) {
            ...
            processDoc = new Marklogic_ProcessDoc(document, elements, out, DELIMITER, docMgr, ROOT_NODE, CUSTOM_TRANSFORM);
